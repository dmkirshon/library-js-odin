...
const newBookSubmissionMessage = document.querySelector(
  ".book-submission-message"
);
...
function submitForm(event) {
  ...
  const newBookSubmission = new Book(
    bookTitle,
    bookAuthor,
    bookPages,
    bookRead
...
bookAuthor.addEventListener("input", (e) => {
  if (bookAuthor.validity.patternMismatch) {
    bookAuthor.setCustomValidity(
      "I am expecting a real name, not mumbo jumbo!"
    );
